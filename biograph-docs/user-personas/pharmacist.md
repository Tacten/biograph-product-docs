...
Use this page as a quick navigation guide. Each workflow represents a common pharmacy task and shows the exact system path to follow.

## Core Pharmacy Workflow (Primary Loop)
...
- Medication Request – View and manage medication orders  
- Item / Stock – Verify availability, batch, and expiry  
- Stock Entry – Update inventory after dispensing  
- Sales Invoice (via Billing) – Ensure medications are billed  
...
Workflow:  
[Item](../specialized/stock-integration.md) → [Stock Balance](../specialized/stock-integration.md) → Batch / Expiry
...
Most pharmacy activities revolve around four core areas:

- Medication Request – Central record for dispensing  
- Patient Encounter – Source of prescriptions  
- Item & Inventory – Stock, batch, and expiry management  
- Stock Entry – Inventory updates after dispensing  

From these, pharmacists can:
- review and verify prescriptions  
- check stock availability and expiry  
- dispense medications safely  
- update inventory and track usage  
- coordinate with billing for revenue capture  

Understanding this flow ensures efficient and safe pharmacy operations.
