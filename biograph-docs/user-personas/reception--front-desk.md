...
## Core Reception Workflow (Primary Loop)
...
- Patient Appointment – Book and manage appointments  
- Appointment Calendar – View daily schedules  
- Check-In – Mark patient arrival  
- Patient Encounter – Link consultation for billing  
- Sales Invoice – Generate billing for services  
- Payment Entry – Collect and record payments  
...
Reception workflows revolve around four core areas:

- Patient – Registration and patient information  
- Patient Appointment – Scheduling and visit management  
- Patient Encounter – Linking consultation to billing  
- Sales Invoice & Payment Entry – Billing and payment processing  

Reception acts as the bridge between:

- Patients (entry point)  
- Practitioners (consultation)  
- Billing (revenue capture)  

Understanding this flow ensures smooth patient handling from arrival to payment completion.
