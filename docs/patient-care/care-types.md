...
|-----------|-------------|
| **Outpatient** | Walk-in or scheduled visits where the patient does not stay overnight |
...
- **Billing categorization** based on care type
- **Reporting and analytics** by care category
